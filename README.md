...
__Observation Angle <br> (red: nadir)__ | __Grid-based Orthomosaic__
![](https://github.com/ethz-asl/aerial_mapper/wiki/observation_angle.gif) | ![](https://github.com/ethz-asl/aerial_mapper/wiki/ortho.gif)
